                      ...
                      -->
                        ...
                        <div class="sidebar-wrapper">
                          <ul class="nav">
                            ...
                            <li class="nav-item"><a  class="nav-link" href="{{ url('/feedbacks')}}">All Feedbacks</a></li>
                            <li class="nav-item"><a  class="nav-link" href="{{ url('/todaysFeedback')}}">Todays Feedbacks</a></li>
                            <li class="nav-item"><a  class="nav-link" href="{{ url('/averages') }}">{{ __('header.averages')}} </a></li>
